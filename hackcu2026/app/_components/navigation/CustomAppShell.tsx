...
import {IconChartBar, IconDashboard, IconLogout, IconMoon, IconSun, IconUser} from "@tabler/icons-react";
                        ...
                        {session?.user && <>
                            <Menu shadow="md" width={200}>
                                ...
                                <MenuDropdown>
                                    ...
                                    <MenuItem leftSection={<IconChartBar size={14}/>} component={Link} href="/sims">
                                        Your Simulations
                                    </MenuItem>
                                    <MenuDivider/>
